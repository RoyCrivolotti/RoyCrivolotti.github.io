...
document.addEventListener('DOMContentLoaded', () => {
	...
	document.querySelectorAll('.superheros img').forEach(img => {
		img.addEventListener('click', loadSuperHero);
	});
	...
	function toggleOpen(event) {
		...
		}).then(() => setTimeout(() => this.classList.toggle(third), 500))
			.then(() => {
